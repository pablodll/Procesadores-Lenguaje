...
public class AnalizadorSintacticoTiny1TokenManager_JAVACC implements AnalizadorSintacticoTiny1Constants_JAVACC
{
...
public AnalizadorSintacticoTiny1TokenManager_JAVACC(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public AnalizadorSintacticoTiny1TokenManager_JAVACC(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
