/* Generated By:JavaCC: Do not edit this line. ConstructorAST_DescTokenManager.java */
package c_ast_descendente;
import asint.Tiny1Asint.*;
import semops.SemOps;

public class ConstructorAST_DescTokenManager implements ConstructorAST_DescConstants
{
...
public ConstructorAST_DescTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ConstructorAST_DescTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
