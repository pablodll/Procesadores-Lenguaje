/* Generated By:JavaCC: Do not edit this line. ConstructorAST_Desc.java */
package c_ast_descendente;

import asint.Tiny1Asint.*;
import semops.SemOps;

public class ConstructorAST_Desc implements ConstructorAST_DescConstants {
  ...
  final public Tipo Tipo() throws ParseException {
    ...
    case Id:
      id = jj_consume_token(Id);
                                                                                                         {if (true) return sem.ref(sem.str(id.image,id.beginLine,id.beginColumn));}
      break;
    case Array:
  ...
  final public Exp RE5(Exp exph) throws ParseException {
                                                                           Exp exp0; Token id; Exp re5;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case 55:
      jj_consume_token(55);
      id = jj_consume_token(Id);
      re5 = RE5(sem.reg_punto(exph,sem.str(id.image,id.beginLine,id.beginColumn)));
                                                                                                                                                                                                         {if (true) return re5;}
      break;
    case 56:
      jj_consume_token(56);
      id = jj_consume_token(Id);
      re5 = RE5(sem.reg_flecha(exph,sem.str(id.image,id.beginLine,id.beginColumn)));
                                                                                                                                                                                                           {if (true) return re5;}
      break;
    case 48:
      jj_consume_token(48);
  ...
  public ConstructorAST_DescTokenManager token_source;
  ...
  public ConstructorAST_Desc(java.io.InputStream stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new ConstructorAST_DescTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public ConstructorAST_Desc(java.io.Reader stream) {
    jj_input_stream = new SimpleCharStream(stream, 1, 1);
    token_source = new ConstructorAST_DescTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public ConstructorAST_Desc(ConstructorAST_DescTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  public void ReInit(ConstructorAST_DescTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
