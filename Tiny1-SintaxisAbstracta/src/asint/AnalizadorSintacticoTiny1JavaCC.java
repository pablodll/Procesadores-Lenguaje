...
public class AnalizadorSintacticoTiny1JavaCC implements AnalizadorSintacticoTiny1JavaCCConstants {
  ...
  final public LparamsF ParamsF() throws ParseException {
                                           LparamsF lparamsf;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case TipoInt:
    case TipoReal:
  ...
  final public Tipo Tipo() throws ParseException {
    ...
    case Record:
      ...
      ltipos = LTipos();
      jj_consume_token(51);
                                                                                                                                                                          {if (true) return sem.record(ltipos);}
      break;
    case Pointer:
  ...
  final public LTipos LTipos() throws ParseException {
                                   LTipos ltipos; Tipo tipo;
    tipo = Tipo();
    jj_consume_token(Id);
    ltipos = RLTipos(sem.tipos_uno(tipo));
  ...
  final public LTipos RLTipos(LTipos ltiposh) throws ParseException {
    ...
    case 43:
      ...
      tipo = Tipo();
      jj_consume_token(Id);
      ltipos = RLTipos(sem.tipos_muchos(ltiposh));
                                                                                                                                               {if (true) return ltipos;}
      break;
    default:
      jj_la1[7] = jj_gen;
  ...
  final public LInsts RLInsts(LInsts linstsh) throws ParseException {
    ...
    case 43:
      jj_consume_token(43);
      inst = Inst();
      linsts = RLInsts(sem.insts_muchas(linstsh));
                                                                                                                                          {if (true) return linsts;}
      break;
    default:
      jj_la1[8] = jj_gen;
  ...
  final public Paramsr ParamsR() throws ParseException {
    ...
    case 57:
      paramsr = LParamsR();
                                                                                  {if (true) return paramsr;}
      break;
    default:
      jj_la1[11] = jj_gen;

                                                                                                        {if (true) return paramsr_vacio();}
    }
    throw new Error("Missing return statement in function");
  }
  ...
  final public Bloque RBloque() throws ParseException {
    ...
    case 57:
      bloque = S();
      jj_consume_token(51);
                                                                            {if (true) return sem.bloque_no_vacio(bloque);}
      break;
    case 51:
  ...
  final public Exp RE5(Exp exph) throws ParseException {
    ...
    case 48:
      ...
      exp0 = E0();
      jj_consume_token(49);
                                                                                                                                    {if (true) return sem.indice(exph,rexp0);}
      break;
    default:
      jj_la1[20] = jj_gen;
